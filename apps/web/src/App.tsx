...
function PrintBook({ path, locale }: { path: string; locale: string }) {
  ...
  if (usesArticleLayout(book.level)) return <PrintArticle book={book} story={story} locale={printLocale} vocabulary={vocabulary} />;
